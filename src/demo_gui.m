...
uicontrol('Parent', fig, ...
    ...
    'FontSize', 18, ...
    'FontWeight', 'bold', ...
    'BackgroundColor', [0.54 0.54 0.54], ...
...
upload_btn = uicontrol('Parent', fig, ...
    ...
    'FontSize', 12, ...
    'FontWeight', 'bold', ...
    'BackgroundColor', [0.35 0.6 0.9], ...   % Soft blue
...
recognize_btn = uicontrol('Parent', fig, ...
    ...
    'Enable', 'off', ...
    'BackgroundColor', [0.2 0.75 0.4], ... % Green highlight
...
result_axes = axes('Parent', fig, ...
    'Units', 'pixels', ...
    'Position', [430, 200, 350, 300], ...
    'Box', 'on', ...
    'XColor', [0.75 0.75 0.75], ...
    'YColor', [0.75 0.75 0.75], ...
    'Color', [0.98 0.99 1.00]);   % very light bluish panel

axis(result_axes, 'off');

title(result_axes, 'Prediction Result', ...
    'FontSize', 16, ...
    'FontWeight', 'bold', ...
...
result_text = uicontrol('Parent', fig, ...
    ...
    'FontSize', 16, ...
    'FontWeight', 'bold', ...
    'BackgroundColor', [0.18 0.45 0.78], ...   % strong professional blue
    'ForegroundColor', [1 1 1], ...
...
confidence_text = uicontrol('Parent', fig, ...
    ...
    'FontSize', 11, ...
    'FontWeight', 'bold', ...
    'BackgroundColor', [1.00 0.95 0.83], ...
    'ForegroundColor', [0.55 0.22 0.00], ...
    'Position', [450, 310, 300, 30]);

%% Probability Bar Chart Area (for top 3 predictions)
prob_axes = axes('Parent', fig, ...
    'Units', 'pixels', ...
    'Position', [450, 130, 300, 150], ...
    'Box', 'on', ...
    'XColor', [0.00 0.00 0.00], ...
    'YColor', [0.00 0.00 0.00], ...
    'Color', [0.99 0.99 0.99]);   % near white chart background

title(prob_axes, 'Prediction Probabilities', ...
    'FontSize', 13, ...
    'FontWeight', 'bold', ...
    'Color', [0.15 0.25 0.45]);
...
uicontrol('Parent', fig, ...
    ...
    'BackgroundColor', [0.90 0.95 1.00], ...   % soft info blue
    'ForegroundColor', [0.10 0.20 0.40], ...
    'Position', [50, 10, 700, 100]);
...
%% ========================================
    function recognize_callback(~, ~)
        ...
        set(confidence_text, ...
            'String', sprintf('Confidence: %.1f%%', confidence * 100), ...
            'FontSize', 11, ...
            'ForegroundColor', [0.73 0.15 0.00]);
        ...
        b = bar(top_3_digits, top_3_probs * 100, ...
            'FaceColor', [0.18 0.45 0.78], ...
            'EdgeColor', [0.1 0.3 0.6], ...
            'LineWidth', 1.2);

        xlabel('Digit', 'FontWeight','bold','Color',[0.1 0.1 0.1]);
        ylabel('Probability (%)', 'FontWeight','bold','Color',[0.1 0.1 0.1]);
